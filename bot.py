...
Если пользователь просит документ, сначала уточни недостающие
данные, если без них невозможно подготовить качественный результат.
Не выдумывай номера, даты и содержание нормативных правовых актов.
"""
